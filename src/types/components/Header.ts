...
export interface HeaderProps {
  ...
  mobileMenuHeightOption?:
    | 'full'
    | 'content' /** Height option for the mobile menu: 'full' screen or 'content' height */
  ...
  position?:
    ...
    | 'sticky'
    | 'static'
    | 'relative' /** Positioning type of the AppBar: 'fixed', 'absolute', etc. */
  hideOnScroll?: boolean /** Whether to hide the header on scroll down and show on scroll up */
  themeColor?:
    | 'primary'
    | 'secondary'
    | 'default' /** Theme color of the AppBar */
